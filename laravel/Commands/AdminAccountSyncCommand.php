...
class AdminAccountSyncCommand extends Command
{
    /** @var string */
    protected $signature = 'admin:account-sync {payload} {--json}';

    /** @var string */
    protected $description = '同步信贷后台 admin 账号（toolbox 远程调用）';
